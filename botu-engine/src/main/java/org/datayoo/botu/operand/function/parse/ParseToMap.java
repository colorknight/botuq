...
public class ParseToMap extends AbstractFunction {

  public static final String FUNCTION_NAME = "parseToMap";
  ...
  public ParseToMap(List<Operand> parameters) {
  ...
  protected Object innerOperate(EntityMap entityMap) {
    ...
    for (String segment : segments) {
      ...
      if (segment.length() > 0) {
        retMap.put(BotuConstants.TMP_VAR_PREFIX + i, segment);
      }
      i++;
    }
    return retMap;
