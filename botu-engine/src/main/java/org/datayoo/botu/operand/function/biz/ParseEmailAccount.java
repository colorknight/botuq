 ...
 * @date 2023/2/7 11:45
 */
public class ParseEmailAccount extends AbstractFunction {

  public static final String FUNCTION_NAME = "parseEmailAccount";

  public ParseEmailAccount(List<Operand> parameters) {
