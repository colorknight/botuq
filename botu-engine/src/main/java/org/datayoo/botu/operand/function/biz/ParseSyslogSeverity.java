...
public class ParseSyslogSeverity extends AbstractFunction {

  public static final String FUNCTION_NAME = "parseSyslogSeverity";

  protected Operand var;

  public ParseSyslogSeverity(List<Operand> parameters) {
